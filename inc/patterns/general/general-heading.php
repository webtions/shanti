...
return array(
	...
	'content'    => '<!-- wp:columns {"verticalAlignment":"center","isStackedOnMobile":false,"align":"wide"} -->
					<div class="wp-block-columns alignwide are-vertically-aligned-center is-not-stacked-on-mobile">
						...
						<div class="wp-block-column is-vertically-aligned-center">
							...
							<h2 class="has-x-large-font-size">Latest posts</h2>
							<!-- /wp:heading -->
						...
						<div class="wp-block-column is-vertically-aligned-center" style="padding-top:0rem;padding-right:0rem;padding-bottom:0rem;padding-left:0rem">
							...
							<!-- wp:separator {"opacity":"css","backgroundColor":"primary","className":"is-style-wide"} -->
