<?php
/**
 * Title: Blog posts in one column.
 * Slug: shanti/blog-default
 * Categories: shanti-blog
 * Viewport Width: 1370
 */
?>

<!-- wp:query {"queryId":0,"query":{"perPage":9,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date"},"align":"wide","layout":{"inherit":false}} -->
