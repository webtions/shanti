...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var(--wp--custom--spacing--outer)","right":"var(--wp--custom--spacing--outer)"}}},"backgroundColor":"accent-light","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-accent-light-background-color has-background"
	style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--custom--spacing--outer);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--custom--spacing--outer)">
	...
	<div class="wp-block-group alignwide"
		...
		<div class="wp-block-columns alignwide"><!-- wp:column {"width":"33.33%"} -->
			<div class="wp-block-column" style="flex-basis:33.33%">
				<!-- wp:heading {"level":2,"style":{"typography":{"fontWeight":"600","fontSize":"2rem"},"spacing":{"margin":{"bottom":"var:preset|spacing|30"}}}} -->
			...
			<div class="wp-block-column" style="flex-basis:66.66%">
				...
				<div class="wp-block-query alignwide">
					<!-- wp:post-template {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|70"}},"layout":{"type":"grid","columnCount":2}} -->
